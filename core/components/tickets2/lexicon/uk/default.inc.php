<?php
/**
 *  Ukrainian Lexicon Entries for Tickets2 (by viktorminator)
 */

include_once('setting.inc.php');

$_lang['tickets2'] = 'Тікети';
$_lang['comments'] = 'Коментарі';
$_lang['threads'] = 'Гілки коментарів';
$_lang['tickets2_section'] = 'Розділ';
$_lang['ticket'] = 'Тікет';
$_lang['ticket_all'] = 'Все';
$_lang['ticket_menu_desc'] = 'Управління коментарями і не тільки.';
$_lang['comments_all'] = 'Всі коментарі';

$_lang['tickets2_section_create_here'] = 'Розділ з тікетами';
$_lang['tickets2_section_new'] = 'Новий розділ тікетів';
...
$_lang['tickets2_err_unknown'] = 'Відбулася невідома помилка.';
$_lang['tickets2_message_close_all'] = 'закрити все';
