...
<!--tickets2_comment_edit_link <a href="#" class="edit">[[%ticket_comment_edit]]</a>-->
<!--tickets2_comment_was_edited <span class="ticket-comment-edited">([[%ticket_comment_was_edited]])</span>-->
<!--tickets2_comment_new  ticket-comment-new-->
<!--tickets2_can_vote  active-->
<!--tickets2_cant_vote  inactive-->
<!--tickets2_rating_positive  positive-->
<!--tickets2_rating_negative  negative-->
<!--tickets2_voted_plus  voted-->
<!--tickets2_voted_minus  voted-->
<!--tickets2_guest  ticket-comment-guest-->
<!--tickets2_has_parent <span class="ticket-comment-up"><a href="[[+url]]#comment-[[+parent]]" data-id="[[+id]]" data-parent="[[+parent]]">&uarr;</a></span>-->
