...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modx->addPackage('Tickets2\Model', MODX_CORE_PATH . 'components/tickets2/src/', null, 'Tickets2\\');
            $manager = $modx->getManager();
            $objects = [];
            $schemaFile = MODX_CORE_PATH . 'components/tickets2/schema/tickets2.mysql.schema.xml';
