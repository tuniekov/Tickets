...
class Tickets2Package
{
    ...
    private function events()
    {
        ...
        foreach ($events as $name => $data) {
            /** @var modEvent $event */
            $event = $this->modx->newObject('MODX\Revolution\modEvent');
            $event->fromArray(array_merge([
                'name' => $name,
                'service' => 6,
...
$modx = new modX();
$install = new Tickets2Package($modx, $config);
