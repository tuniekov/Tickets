Tickets2.page.UpdateTicket = function (config) {
    ...
    Tickets2.page.UpdateTicket.superclass.constructor.call(this, config);
};

Ext.extend(Tickets2.page.UpdateTicket, MODx.page.UpdateResource, {
...
Ext.reg('tickets2-page-ticket-update', Tickets2.page.UpdateTicket);