Tickets2.panel.Ticket = function (config) {
    config = config || {};

    Ext.applyIf(config, {});
    Tickets2.panel.Ticket.superclass.constructor.call(this, config);
};

Ext.extend(Tickets2.panel.Ticket, MODx.panel.Resource, {
    ...
    getFields: function (config) {
        ...
        for (var i in originals) {
            ...
            if (item.id == 'modx-resource-tabs') {
                item.stateful = true;
                item.stateId = 'tickets2-' + config.mode + '-tabpanel';
        ...
        return [
            {
                ...
                id: 'tickets2-box-publishing-information',
                defaults: {
                    msgTarget: 'under'
                },
                items: [{
                    ...
                    xtype: MODx.config.publish_document ? 'tickets2-combo-user' : 'hidden',
                    ...
                    xtype: MODx.config.publish_document ? 'tickets2-combo-section' : 'hidden',
                    id: 'tickets2-combo-section',
    ...
    getCheckboxes: function (config) {
        ...
        var tmp = {
            ...
            disable_jevix: {
                ...
                checked: config.record.properties['tickets2']['disable_jevix']
            },
            cacheable: {},
            process_tags: {
                ...
                checked: config.record.properties['tickets2']['process_tags']
            },
            published: {},
...
Ext.reg('modx-panel-ticket', Tickets2.panel.Ticket);
