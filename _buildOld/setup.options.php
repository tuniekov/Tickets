...
if (!$exists) {
    switch ($modx->getOption('manager_language')) {
        case 'ru':
            ...
            break;
        default:
            $output = 'This component is require snippet <b>Jevix</b> for filtering output of tickets2 and <b>pdoTools</b> for fast work <with></with> database.<br/><br/>Can i automaticly download and install them?';
    }
}
